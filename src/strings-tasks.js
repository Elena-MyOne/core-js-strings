...
function concatenateStrings(value1, value2) {
  return [...value1].concat([...value2]).join('');
}
...
function isPalindrome(str) {
  const newSrt = str.replace(/[^a-zA-Z0-9]/g, '').toLowerCase();
  return newSrt === newSrt.split('').reverse().join('');
}
